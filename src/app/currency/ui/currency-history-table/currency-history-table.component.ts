...
@Component({
  selector: "app-currency-history-table",
  imports: [MatTableModule, DatePipe, CurrencyConvertPipe, CurrencyPipe],
  templateUrl: "./currency-history-table.component.html",
  styleUrl: "./currency-history-table.component.scss",
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CurrencyHistoryTableComponent {
